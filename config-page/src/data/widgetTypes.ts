...
const WIDGET_TEMPLATES: WidgetOptionTemplate[] = [
  ...
  { value: '{cond}', label: 'Current Condition (Text)', category: 'Weather' },
  { value: '{cond_day}', label: "Today's Condition (Text)", category: 'Weather' },
  { value: '{weather_icon}', label: 'Current Condition (Icon)', category: 'Weather' },
  { value: '{weather_icon_day}', label: "Today's Condition (Icon)", category: 'Weather' },
...
export const WIDGET_TOKENS: WidgetToken[] = [
  ...
  { token: '{weather_icon}', label: 'Icon (Whole Slot)', category: 'Weather' },
  { token: '{weather_icon_day}', label: 'Day Icon (Whole Slot)', category: 'Weather' },
